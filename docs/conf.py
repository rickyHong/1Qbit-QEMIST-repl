...
html_logo = 'logo_1qbit_white.png'
html_theme_options = {
        'navigation_depth': 6,
...
latex_documents = [
    (master_doc, 'QEMIST.tex', 'QEMIST Documentation',
     'Rudi Plesch, Valentin Senicourt, Yukio Kawashima, Lee Huntington, Prakash Verma, Takeshi Yamazaki, Arman Zaribafiyan', 'manual'),
]
